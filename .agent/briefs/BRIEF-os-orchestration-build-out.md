...
brief-id: project-orchestration-os-orchestration-build-out
...
> PD — is project-orchestration's own scope. Physically redistributed here per
> project-totebox's own 2026-07-08 routing-note request. Content below is unchanged
> from the original except this note and the frontmatter (status/owner/updated).
